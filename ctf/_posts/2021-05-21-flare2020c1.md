...
> 
> Looking for solutions? There are a lot of blog posts, but FireEye has the [solutions](https://www.fireeye.com/blog/threat-research/2020/10/flare-on-7-challenge-solutions.html) as well
...
![](../../assets/flare2020_c1_passscreen.png)
...
# conclusions
If you had prior knowledge of python or programming in general, this would not have been too difficult to figure out. If you wanted a challenge, disassembling the binary and figuring it out that way would've been the way to go.

To me, this challenge emphasized focusing on some details while ignoring others which is a very thin line to walk. There's a ton of boilerplate code that can be skipped, but getting in the habit of skipping code can have negative consequences. For this challenge, it says you need "about 100 billion" coins to win, but what does "about" even mean? 1.1 billion? 1.2 billion? 1.00001 billion? We found out that it was literally some values in a very limited range, so if you attempted to brute force the solution without knowing the specific range, you may have inadvertently missed the magic range.
